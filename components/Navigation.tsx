  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black border-b-2 border-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile Navigation */}
        {isOpen && (
          <div className="md:hidden border-t-2 border-black bg-black">
            <div className="flex flex-col py-4 space-y-4">
              <Link
                href="/"
                onClick={() => setIsOpen(false)}
                className="text-white hover:text-gray-300 transition-colors font-medium uppercase text-sm tracking-wide px-4 py-2"
              >
                Home
              </Link>
              <Link
              ...
              <Link
                href="/contact"
                onClick={() => setIsOpen(false)}
                className="bg-white text-black px-6 py-3 mx-4 border-2 border-white hover:bg-gray-100 transition-colors font-bold uppercase text-sm tracking-wide text-center"
              >
